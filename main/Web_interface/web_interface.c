...
static esp_err_t rootHandler(httpd_req_t *req)
{
    static const char html[] =
        ...
        "}"
        "const labels=(pace||voltronic||china)?['MOS','Battery T1','Battery T2','Battery T4','Battery T5']:(nativeJk?['Tube/MOS','Battery','Box','T4','T5']:['MOS','T1','T2','T4','T5']);"
