...
static esp_err_t rootHandler(httpd_req_t *req)
{
    static const char html[] =
        ...
        "const UI_BUILD='2026.07.03-savefix2';"
        ...
        "];"
        "const actions='<div class=\"actions\"><button onclick=\"saveSettings()\">Apply</button><span id=\"settingsStatus\" class=\"mono\">UI '+UI_BUILD+'</span></div><div id=\"routeHint\" class=\"mono\" style=\"margin-top:8px;color:#8aa0b7\"></div>';"
