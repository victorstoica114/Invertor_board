...
static esp_err_t rootHandler(httpd_req_t *req)
{
    static const char html[] =
        ...
        "function currentRouteKey(){return routeKey(parseInt(document.getElementById('mode').value,10),parseInt(document.getElementById('bms_line').value,10),parseInt(document.getElementById('inverter_line').value,10),parseInt(document.getElementById('bms_protocol').value,10),parseInt(document.getElementById('inverter_protocol').value,10),parseInt(document.getElementById('bms_port').value,10),parseInt(document.getElementById('inverter_port').value,10));}"
        ...
        "const txt=renderRouteHint(s.mode_id,s.bms_line_id,s.inverter_line_id,s.bms_protocol_id,s.inverter_protocol_id,s.bms_port,s.inverter_port);"
