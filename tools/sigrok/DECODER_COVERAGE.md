...
| `jkbms_can` | `main/protocols/jkbms_can/jkbms_can_protocol.*`, JK CAN V2.0 references | Native JK CAN at `250 kbit/s`, standard pack/status frames, extended cell-voltage frames, temperature frames, raw CANH/CANL input modes | Needs more live validation for every extended frame variant and BMS-ID suffix behavior. |
